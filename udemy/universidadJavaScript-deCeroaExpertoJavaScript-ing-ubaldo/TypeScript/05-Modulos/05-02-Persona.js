...
const _05_01_Modulos_1 = require("./05-01-Modulos"); /* No es necesario especificar el .ts, porq automaticamente nos reconoce el
...
*/
let persona1 = new _05_01_Modulos_1.Persona("Ezequiel");
console.log("hola");
